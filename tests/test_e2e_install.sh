...
cat > "$PROJECT_DIR/.wizard-state.json" << 'STATEEOF'
{
  ...
  "models": {"brain": "claude-sonnet-4", "builder": "deepseek-v3", "researcher": "qwen-max", "verifier": "qwen-max", "guardian": "claude-sonnet-4"},
  "providers": {"brain": "anthropic", "builder": "deepseek", "researcher": "alibaba", "verifier": "alibaba", "guardian": "anthropic"},
...
check "agents/researcher/SOUL.md exists" test -f "$OC_WS/agents/researcher/SOUL.md"
