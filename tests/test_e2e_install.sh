...
cat > "$PROJECT_DIR/.wizard-state.json" << 'STATEEOF'
{
  ...
  "models": {"brain": "claude-sonnet-4", "builder": "deepseek-v3", "scout": "qwen-max", "checker": "qwen-max", "guardian": "claude-sonnet-4"},
  "providers": {"brain": "anthropic", "builder": "deepseek", "scout": "alibaba", "checker": "alibaba", "guardian": "anthropic"},
...
check "agents/scout/SOUL.md exists" test -f "$OC_WS/agents/scout/SOUL.md"
check "agents/checker/SOUL.md exists" test -f "$OC_WS/agents/checker/SOUL.md"
