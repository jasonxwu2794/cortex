...
wizard_spin "Installing aider-chat..." python3 -m pip install --break-system-packages --ignore-installed aider-chat 2>/dev/null || python3 -m pip install --break-system-packages aider-chat
